...
class Field: # This may be a maze later on.
    def __init__(self, length=5, width=5, num_ants=1):          # Generic set to 5x5
        ...
        self.colony = [5, 5]                                    # Top left corner
        self.food_collected = 0                                 # Amount of food ants collect
        self.food_coord = [self.length - 3, self.width - 5]     # Bottom right corner for now
...
if __name__ == "__main__":
    field = Field(15, 15, 65)        # Field of dimension y=12, x=10. Number of ants = 5
